...
[3]リードミー#ファイル名：<b>Tochino</b><br>1.重要な注意ーーーーーーーーーー<br>特になし。<br>TaSU-K25から移行したストーリーファイルです。<br><br>2.あらすじーーーーーーーーーーー<br>天変地異に見舞われたロクボン島。酪農を営む 栃野 圭（とちの けい） は、隣町への道すがら、とある脅威に遭遇する。<br><br>3.登場人物ーーーーーーーーーーー<br>・栃野 圭<br>ロクボン島で小さな牧場をほそぼそと経営している牧人。<br><br>・出水（いみず）<br>太寧湾内災害対策局の職員<br><br>4.注意事項ーーーーーーーーーーー<br>このページデータ内のストーリーはフィクションであり、登場する人物名、団体名等は実在のものではありません。<br>また、書かれている説明が、実際と異なる場合があります。<br>書かれている内容は作者の意見を代弁するものではなく、特定の意見を主張するものでもありません。<br><br>1版<br>2025.7. 竹馬浬
</item>
